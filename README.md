...
git clone https://github.com/nusc-summer-school/advanced-data-analysis-r.git cd advanced-data-analysis-r
...
1. Gapminder: Global development indicators for countries over tim
